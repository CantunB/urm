                                                        ...
                                                        <?php $__currentLoopData = $requesteds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">
                                                                    <button type="button"  value="Delete" onclick="deleteRow(this)" class="btn btn-danger btn-sm"><i class="fas fa-minus-circle">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP\Laravel\urm\resources\views/compras/ordenes/show.blade.php ENDPATH**/ ?>