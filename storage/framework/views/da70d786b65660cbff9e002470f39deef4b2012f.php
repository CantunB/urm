    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="badge badge-danger rounded-circle noti-icon-badge"><?php echo e(auth()->user()->count()); ?></span>
                </a>
            </li>
        ...
        <div class="logo-box">
            ...
            <a href="index.html" class="logo logo-light text-center">
                ...
                <span class="logo-lg">
                    <img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" alt="" height="20">
                </span>
            </a>
        </div>
...
<?php /**PATH /Users/bernacantun/Documents/Proyectos/urm/resources/views/layouts/partials/topbar.blade.php ENDPATH**/ ?>