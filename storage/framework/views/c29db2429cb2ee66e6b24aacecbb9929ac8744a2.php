                ...
                <div class=" row justify-content-start d-inline-blocks" style="font-size: x-small;text-align: start">
                    ...
                    <div class="col-md-4 offset-1" style="float-left">
                        <p style="font-size: 7px;text-align: start">
                            ...
                            <strong>
                                <?php echo e($purchaseorder->purchasorder->department->area->coordinations->name); ?> <br>
                            </strong>
                            <strong>
                                <?php echo e($purchaseorder->purchasorder->department->area->departments->name); ?> <br>
                            </strong>
                        </p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\PHP\Laravel\urm\resources\views/compras/ordenes/ordenescompra_pdf.blade.php ENDPATH**/ ?>