...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h1 style="text-transform:uppercase;" class="header-title"><strong> REQUISICIÓN No. <?php echo e($requisition[0]->folio); ?></strong></h1>
                <div class="row mb-2">
                    <div class="col-sm-12">
                ...
                <?php endif; ?>
                <form id="form" action="<?php echo e(route('requisiciones.file_upload',$requisition[0]->id)); ?>" class="form-group" method="POST" enctype="multipart/form-data" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bernacantun/Documents/Proyectos/urm/resources/views/requisitions/upload.blade.php ENDPATH**/ ?>