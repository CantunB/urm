            ...
            <tr>
                <td style="width: 15px">
                    <input id="name" type="number" min="0"
                           ...
                           name="quantity[]" value="{{ old('quantity') ?: $almacen->quantity}}" required autocomplete="quantity" autofocus>
                ...
                @enderror
                <td style="width: 10rem"><input type="text" name="unit[]" class="form-control" value="{{ old('unit') ?: $almacen->unit}}" required></td>
                <td><input type="text" name="concept[]" class="form-control" value="{{ old('concept') ?: $almacen->concept}}"></td>
                <td><input type="text" name="description[]" class="form-control" value="{{ old('name') ?: $almacen->description}}"></td>
