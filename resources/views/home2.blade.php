...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{route('usuarios.index')}}">
                <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-star')}}"></use>
                </svg> Icons</a>
            <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                ...
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="404.html" target="_top">
                        <svg class="c-sidebar-nav-icon">
                            <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-bug')}}"></use>
                        </svg> Error 404</a></li>
...
<div class="c-wrapper c-fixed-components">
    ...
    <div class="c-body">
                            ...
                            <div class="card">
                                <div class="card-header bg-facebook content-center">
                                    <svg class="c-icon c-icon-3xl text-white my-4">
                                        <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-facebook-f')}}"></use>
                                    </svg>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <div class="card-header bg-twitter content-center">
                                    <svg class="c-icon c-icon-3xl text-white my-4">
                                        <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-twitter')}}"></use>
                                    </svg>
                                </div>
                                <div class="card-body row text-center">
                                    <div class="col">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <div class="card-header bg-linkedin content-center">
                                    <svg class="c-icon c-icon-3xl text-white my-4">
                                        <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-linkedin')}}"></use>
                                    </svg>
                                </div>
                                <div class="card-body row text-center">
                                    <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="progress-group mb-5">
                                                <div class="progress-group-header">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-user-female')}}"></use>
                                                    </svg>
                                                    <div>Female</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-google')}}"></use>
                                                    </svg>
                                    ...
                                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('admin/assets/img/avatars/1.jpg')}}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/flag.svg#cif-us')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cc-mastercard')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('admin/assets/img/avatars/2.jpg')}}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/flag.svg#cif-br')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('admin/assets/img/avatars/3.jpg')}}" alt="user@email.com"><span class="c-avatar-status bg-warning"></span></div>
                                            </td>
                                            <td>
                                                <div>Quintin Ed</div>
                                                <div class="small text-muted"><span>New</span> | Registered: Jan 1, 2015</div>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/flag.svg#cif-in')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cc-stripe')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('admin/assets/img/avatars/4.jpg')}}" alt="user@email.com"><span class="c-avatar-status bg-secondary"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/flag.svg#cif-fr')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cc-paypal')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('admin/assets/img/avatars/5.jpg')}}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/flag.svg#cif-es')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cc-apple-pay')}}"></use>
                                            </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img" src="{{asset('admin/assets/img/avatars/6.jpg')}}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/flag.svg#cif-pl')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use xlink:href="{{asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cc-amex')}}"></use>
                                                </svg>
                                            </td>
                                            <td>
        ...
        <footer class="c-footer">
            ...
            <div class="ml-auto">Powered by&nbsp;<a href="#">Bernabe Cantun</a></div>
        </footer>
    </div>
</div>
...
<script src="{{asset('admin/node_modules/@coreui/chartjs/dist/js/coreui-chartjs.bundle.js')}}"></script>
<script src="{{asset('admin/node_modules/@coreui/utils/dist/coreui-utils.js')}}"></script>
